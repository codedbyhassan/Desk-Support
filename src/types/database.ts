...
export interface User{id:string;username:string;full_name:string;avatar_url:string|null;phone:string|null;last_seen_at:string|null;is_online:boolean;company_id?:string;role?:UserRole;department_id?:string|null;email?:string|null;created_at:string;updated_at:string}
