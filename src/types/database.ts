...
export interface User{id:string;full_name:string;avatar_url:string|null;avatar_path:string|null;phone:string|null;last_seen_at:string|null;is_online:boolean;company_id?:string;role?:UserRole;department_id?:string|null;email?:string|null;created_at:string;updated_at:string}
export interface Asset{id:string;company_id:string;asset_tag:string;name:string;description:string|null;category:string|null;manufacturer:string|null;model:string|null;serial_number:string|null;status:AssetStatus;condition:AssetCondition;purchase_date:string|null;purchase_cost:number|null;warranty_expires_at:string|null;location:string|null;notes:string|null;metadata:Json;created_by:string|null;created_at:string;updated_at:string;archived_at?:string|null;assigned_to?:string|null;assigned_at?:string|null}
...
export interface AssetMaintenance{id:string;asset_id:string;maintenance_type:'repair'|'preventive'|'inspection'|'cleaning'|'upgrade'|'other';status:'open'|'in_progress'|'completed'|'cancelled';description:string;performed_by:string|null;vendor_name:string|null;cost:number|null;started_at:string|null;completed_at:string|null;next_due_at:string|null;notes:string|null;created_by:string|null;created_at:string;updated_at:string}
...
export type AssetInsert=Omit<Asset,'id'|'created_at'|'updated_at'|'archived_at'|'assigned_to'|'assigned_at'>&{metadata?:Json}
export type AssetUpdate=Partial<Omit<Asset,'id'|'company_id'|'created_at'|'updated_at'|'assigned_to'|'assigned_at'>>
export type AssetFilters={status?:AssetStatus;assignedTo?:string;category?:string;search?:string}
export interface Ticket{id:string;ticket_number:number;company_id:string;subject:string;title?:string;description:string|null;status:TicketStatus;priority:TicketPriority;channel:TicketChannel;category_id:string|null;department_id:string|null;team_id:string|null;requester_id:string;created_by:string;accepted_by:string|null;accepted_at:string|null;resolved_at:string|null;closed_at:string|null;due_at:string|null;first_response_due_at:string|null;sla_policy_id:string|null;sla_breached_at:string|null;waiting_reason:string|null;escalation_level:number;archived_at:string|null;metadata:Json;created_at:string;updated_at:string;category?:{id:string;name:string}|null;creator?:User|null;requester?:User|null;assignee?:User|null;assignment?:TicketAssignment|null}
