...
export type AssetInsert=Omit<Asset,'id'|'created_at'|'updated_at'|'archived_at'|'assigned_to'|'assigned_at'|'primary_image_url'>&{metadata?:Json}
export type AssetUpdate=Partial<Omit<Asset,'id'|'company_id'|'created_at'|'updated_at'|'assigned_to'|'assigned_at'|'primary_image_url'>>
