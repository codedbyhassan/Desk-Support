...
export function ThemeProvider({children}:{children:ReactNode}) {
  ...
  const [customTheme,setCustomTheme]=useState(()=>readJson('customTheme',defaults))
  const [themeSettings,setThemeSettings]=useState(()=>readJson('themeSettings',defaultSettings))
  ...
  useEffect(()=>{Object.entries(customTheme).forEach(([k,v])=>document.documentElement.style.setProperty(`--color-${k}`,v)); localStorage.setItem('customTheme',JSON.stringify(customTheme))},[customTheme])
