...
export function TicketForm({ onSubmit }: TicketFormProps) {
  ...
  const [channel, setChannel] = useState<'portal' | 'email' | 'phone' | 'chat' | 'other'>('portal')
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      /*
       * This object intentionally contains only columns that exist on public.tickets.
       * ticket_number is generated by the database BEFORE INSERT, so the client does
       * not manufacture ticket numbers or race another browser creating a ticket.
       */
      const ticketPayload = {
      ...
      <div className="border-b border-border bg-muted/30 px-5 py-5 sm:px-6">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-0.5 text-sm text-muted-foreground">Describe the issue and we'll route it through the support workflow.</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-7 p-5 sm:p-6">
        <section className="space-y-4">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">Keep the subject concise and give enough detail for someone to act on it.</p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              required
              disabled={loading}
              className="h-11 rounded-xl bg-card shadow-sm"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Explain what happened, what you expected, and any useful details."
              rows={6}
              disabled={loading}
              className="min-h-[140px] resize-y rounded-xl bg-card shadow-sm"
            />
          </div>
        </section>
        ...
        <section className="space-y-4 border-t border-border pt-6">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">These values are saved directly to the ticket record.</p>
          </div>
            ...
            <div className="space-y-2">
              ...
              <Select value={categoryId} onValueChange={setCategoryId} disabled={loading || loadingCategories}>
                <SelectTrigger className="h-11 rounded-xl bg-card shadow-sm">
                  ...
                  <SelectValue placeholder={loadingCategories ? 'Loading categories…' : 'No category'} />
                </SelectTrigger>
                <SelectContent className="bg-card">
        ...
        <section className="space-y-4 border-t border-border pt-6">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">Add a direct image URL if the issue needs visual context.</p>
          </div>
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                placeholder="https://example.com/issue.png"
                disabled={loading}
