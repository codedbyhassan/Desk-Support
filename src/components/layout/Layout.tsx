...
import { LayoutDashboard, Ticket, Package, Building2, Users, Settings, Bell, QrCode, BriefcaseBusiness, SlidersHorizontal, Activity } from 'lucide-react'
    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="flex min-h-screen">
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          ...
          <main className={isCallRoute ? 'min-h-screen flex-1' : 'min-w-0 flex-1 overflow-x-hidden pb-0'}>
