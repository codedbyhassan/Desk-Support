...
export default function DepartmentsPage() {
  ...
  return (
    <div className="space-y-3 sm:space-y-4 lg:space-y-6 px-0">
      {/* Header */}
      <div className="flex flex-col gap-3 lg:gap-4 px-4 sm:px-0">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
          <div className="space-y-1 lg:space-y-2 flex-1 min-w-0">
            <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold tracking-tight break-words">Departments</h1>
            <p className="text-gray-500 flex items-center gap-1 text-xs sm:text-sm lg:text-base">
      ...
      {hasManagementView ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6 px-4 sm:px-0">
          {loading ? (
            ...
            <div className="col-span-full text-center py-8 lg:py-12">
              ...
              <h3 className="text-sm sm:text-base lg:text-lg font-medium text-gray-900 mb-1 lg:mb-2">
                No departments found
              </h3>
              <p className="text-gray-500 text-xs sm:text-sm mb-3 lg:mb-4 px-4">
            ...
            filteredDepartments.map((dept) => (
              <Card
                key={dept.id}
                className="p-3 sm:p-4 lg:p-6 cursor-pointer hover:shadow-lg transition-all duration-200 relative overflow-hidden group border-slate-200"
                ...
                <div className="relative">
                  ...
                  <div className="flex items-start gap-3 lg:block">
                    ...
                    <div className="h-10 w-10 sm:h-12 sm:w-12 lg:h-12 lg:w-12 rounded-lg sm:rounded-xl bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center shadow-lg shadow-orange-500/30 flex-shrink-0">
                      <Building2 className="h-5 w-5 sm:h-6 sm:w-6 lg:h-6 lg:w-6 text-white" />
                    </div>
                    ...
                    <div className="flex-1 min-w-0 lg:mt-4">
                      ...
                      {/* Description */}
                      <p className="text-[10px] sm:text-xs lg:text-sm text-gray-600 line-clamp-2 leading-relaxed mb-2 lg:mb-3">
                        {dept.description}
                      </p>

                      {/* Stats - Horizontal on Mobile */}
                      <div className="flex items-center gap-2 sm:gap-3 lg:grid lg:grid-cols-3 lg:gap-4 pt-2 lg:pt-4 border-t border-slate-100">
                        <div className="flex-1 flex items-center gap-1.5 lg:flex-col lg:text-center">
                          <Users className="h-3 w-3 sm:h-3.5 sm:w-3.5 lg:h-4 lg:w-4 text-gray-600 flex-shrink-0" />
                          <div className="lg:mt-1 min-w-0">
                            <p className="text-xs sm:text-sm lg:text-2xl font-bold text-gray-900 truncate lg:truncate-none">
                              {dept._count?.members || 0}
                            </p>
                            <p className="text-[8px] sm:text-[9px] lg:text-xs text-gray-500 hidden lg:block">Members</p>
                          </div>
                        </div>
                        <div className="flex-1 flex items-center gap-1.5 lg:flex-col lg:text-center">
                          ...
                          <div className="lg:mt-1 min-w-0">
                            ...
                            <p className="text-[8px] sm:text-[9px] lg:text-xs text-gray-500 hidden lg:block">Pending</p>
                          </div>
                        </div>
                        <div className="flex-1 flex items-center gap-1.5 lg:flex-col lg:text-center">
                          ...
                          <div className="lg:mt-1 min-w-0">
                            ...
                            <p className="text-[8px] sm:text-[9px] lg:text-xs text-gray-500 hidden lg:block">Total</p>
                          </div>
                        </div>
                      </div>
        ...
        <Card className="border-slate-200 rounded-2xl lg:rounded-3xl mx-4 sm:mx-0">
          <div className="p-3 sm:p-4 lg:p-6 space-y-3 sm:space-y-4 lg:space-y-6">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-2 lg:gap-4">
              <Card className="p-2 sm:p-3 lg:p-4 relative overflow-hidden border-slate-200">
                ...
                <div className="relative flex items-center gap-2 lg:gap-3">
                  ...
                  <div className="min-w-0">
                    <p className="text-[10px] sm:text-xs lg:text-sm text-gray-500 uppercase tracking-wide">Pending Tickets</p>
              ...
              <Card className="p-2 sm:p-3 lg:p-4 relative overflow-hidden border-slate-200">
                ...
                <div className="relative flex items-center gap-2 lg:gap-3">
                  ...
                  <div className="min-w-0">
                    <p className="text-[10px] sm:text-xs lg:text-sm text-gray-500 uppercase tracking-wide">My Active</p>
                    <p className="text-lg sm:text-xl lg:text-2xl font-semibold">0</p>
                  </div>
                </div>
              </Card>

              <Card className="p-2 sm:p-3 lg:p-4 relative overflow-hidden border-slate-200 col-span-2 lg:col-span-1">
                ...
                <div className="relative flex items-center gap-2 lg:gap-3">
                  ...
                  <div className="min-w-0">
                    <p className="text-[10px] sm:text-xs lg:text-sm text-gray-500 uppercase tracking-wide">Completed</p>
                    <p className="text-lg sm:text-xl lg:text-2xl font-semibold">0</p>
                  </div>
                </div>
              </Card>
