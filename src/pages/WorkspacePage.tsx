...
import { Download, File, FileImage, FileSpreadsheet, FileText, Folder, FolderPlus, Grid3X3, Home, List, MoreHorizontal, Pencil, Search, Star, Trash2, Upload } from 'lucide-react'
